import{s as it,n as ye,b as De,c as lt}from"../chunks/DXDyIBdz.js";import{S as nt,i as rt,d as r,k as Ye,b as e,a as we,l as a,m as ot,c as s,g,e as d,f as S,n as he,x as ct,h as i,j as v,t as T,H as ht}from"../chunks/B0Ml5HMa.js";import{e as fe}from"../chunks/D6YF6ztN.js";import{p as dt}from"../chunks/BuqzGUd0.js";function Ze(l,o,p){const u=l.slice();return u[5]=o[p],u}function et(l,o,p){const u=l.slice();return u[8]=o[p],u}function tt(l){let o,p=l[8]+"",u;return{c(){o=i("span"),u=T(p),this.h()},l(c){o=s(c,"SPAN",{class:!0});var m=d(o);u=S(m,p),m.forEach(r),this.h()},h(){a(o,"class","tag svelte-15qmzvl")},m(c,m){we(c,o,m),e(o,u)},p:ye,d(c){c&&r(o)}}}function at(l){let o,p,u,c,m,h,f,b=l[5].category+"",Q,j,q,_=l[5].title+"",C,U,E,X=l[5].excerpt+"",z,Y;return{c(){o=i("a"),p=i("div"),u=i("img"),m=v(),h=i("div"),f=i("div"),Q=T(b),j=v(),q=i("h3"),C=T(_),U=v(),E=i("p"),z=T(X),Y=v(),this.h()},l(V){o=s(V,"A",{href:!0,class:!0});var k=d(o);p=s(k,"DIV",{class:!0});var oe=d(p);u=s(oe,"IMG",{src:!0,alt:!0,class:!0}),oe.forEach(r),m=g(k),h=s(k,"DIV",{class:!0});var I=d(h);f=s(I,"DIV",{class:!0});var Z=d(f);Q=S(Z,b),Z.forEach(r),j=g(I),q=s(I,"H3",{class:!0});var D=d(q);C=S(D,_),D.forEach(r),U=g(I),E=s(I,"P",{class:!0});var ce=d(E);z=S(ce,X),ce.forEach(r),I.forEach(r),Y=g(k),k.forEach(r),this.h()},h(){De(u.src,c=l[5].image)||a(u,"src",c),a(u,"alt",l[5].title),a(u,"class","svelte-15qmzvl"),a(p,"class","related-image svelte-15qmzvl"),a(f,"class","related-category svelte-15qmzvl"),a(q,"class","svelte-15qmzvl"),a(E,"class","svelte-15qmzvl"),a(h,"class","related-content svelte-15qmzvl"),a(o,"href",`/blog/${l[5].id}`),a(o,"class","related-card svelte-15qmzvl")},m(V,k){we(V,o,k),e(o,p),e(p,u),e(o,m),e(o,h),e(h,f),e(f,Q),e(h,j),e(h,q),e(q,C),e(h,U),e(h,E),e(E,z),e(o,Y)},p:ye,d(V){V&&r(o)}}}function ut(l){let o,p,u,c,m,h,f,b,Q=l[0].category+"",j,q,_,C,U=l[0].date+"",E,X,z,Y="•",V,k,oe=l[0].readTime+"",I,Z,D,ce=l[0].title+"",be,_e,ee,Pe=l[0].excerpt+"",ke,ze,P,B,Me,xe,M,te,Le=l[0].author+"",qe,Ee,R,He="Real Estate Expert",Ie,ae,F,We,Ae,A,de,st=l[0].content+"",ue,N,Se,$,je='<div class="share-label svelte-15qmzvl">Share this article:</div> <div class="share-buttons svelte-15qmzvl"><button class="share-button svelte-15qmzvl" aria-label="Share on Twitter"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M22 4s-.7 2.1-2 3.4c1.6 10-9.4 17.3-18 11.6 2.2.1 4.4-.6 6-2C3 15.5.5 9.6 3 5c2.2 2.6 5.6 4.1 9 4-.9-4.2 4-6.6 7-3.8 1.1 0 3-1.2 3-1.2z"></path></svg></button> <button class="share-button svelte-15qmzvl" aria-label="Share on Facebook"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"></path></svg></button> <button class="share-button svelte-15qmzvl" aria-label="Share on LinkedIn"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M16 8a6 6 0 0 1 6 6v7h-4v-7a2 2 0 0 0-2-2 2 2 0 0 0-2 2v7h-4v-7a6 6 0 0 1 6-6z"></path><rect x="2" y="9" width="4" height="12"></rect><circle cx="4" cy="4" r="2"></circle></svg></button> <button class="share-button svelte-15qmzvl" aria-label="Copy link"><svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M10 13a5 5 0 0 0 7.54.54l3-3a5 5 0 0 0-7.07-7.07l-1.72 1.71"></path><path d="M14 11a5 5 0 0 0-7.54-.54l-3 3a5 5 0 0 0 7.07 7.07l1.71-1.71"></path></svg></button></div>',Te,se,L,G,Be="Related Articles",Ce,O,Ve,K,Re='<div class="container svelte-15qmzvl"><div class="cta-card svelte-15qmzvl"><h2 class="svelte-15qmzvl">Expert Real Estate Guidance</h2> <p class="svelte-15qmzvl">Connect with our team for personalized advice on buying, selling, or investing in today&#39;s dynamic market.</p> <a href="/contact" class="cta-button svelte-15qmzvl">Contact Our Team</a></div></div>';document.title=o=l[0].title+" | WASAW Blog";let ie=fe(l[0].tags),y=[];for(let n=0;n<ie.length;n+=1)y[n]=tt(et(l,ie,n));let le=fe(l[1]),w=[];for(let n=0;n<le.length;n+=1)w[n]=at(Ze(l,le,n));return{c(){p=i("meta"),u=v(),c=i("article"),m=i("div"),h=i("div"),f=i("div"),b=i("div"),j=T(Q),q=v(),_=i("div"),C=i("span"),E=T(U),X=v(),z=i("span"),z.textContent=Y,V=v(),k=i("span"),I=T(oe),Z=v(),D=i("h1"),be=T(ce),_e=v(),ee=i("p"),ke=T(Pe),ze=v(),P=i("div"),B=i("img"),xe=v(),M=i("div"),te=i("span"),qe=T(Le),Ee=v(),R=i("span"),R.textContent=He,Ie=v(),ae=i("div"),F=i("img"),Ae=v(),A=i("div"),de=new ht(!1),ue=v(),N=i("div");for(let n=0;n<y.length;n+=1)y[n].c();Se=v(),$=i("div"),$.innerHTML=je,Te=v(),se=i("div"),L=i("div"),G=i("h2"),G.textContent=Be,Ce=v(),O=i("div");for(let n=0;n<w.length;n+=1)w[n].c();Ve=v(),K=i("div"),K.innerHTML=Re,this.h()},l(n){const x=ot("svelte-1rhu2rt",document.head);p=s(x,"META",{name:!0,content:!0}),x.forEach(r),u=g(n),c=s(n,"ARTICLE",{class:!0});var t=d(c);m=s(t,"DIV",{class:!0});var H=d(m);h=s(H,"DIV",{class:!0});var W=d(h);f=s(W,"DIV",{class:!0});var pe=d(f);b=s(pe,"DIV",{class:!0});var Fe=d(b);j=S(Fe,Q),Fe.forEach(r),q=g(pe),_=s(pe,"DIV",{class:!0});var ne=d(_);C=s(ne,"SPAN",{});var Ne=d(C);E=S(Ne,U),Ne.forEach(r),X=g(ne),z=s(ne,"SPAN",{class:!0,"data-svelte-h":!0}),he(z)!=="svelte-5uf9ts"&&(z.textContent=Y),V=g(ne),k=s(ne,"SPAN",{});var $e=d(k);I=S($e,oe),$e.forEach(r),ne.forEach(r),pe.forEach(r),Z=g(W),D=s(W,"H1",{class:!0});var Ge=d(D);be=S(Ge,ce),Ge.forEach(r),_e=g(W),ee=s(W,"P",{class:!0});var Oe=d(ee);ke=S(Oe,Pe),Oe.forEach(r),ze=g(W),P=s(W,"DIV",{class:!0});var ge=d(P);B=s(ge,"IMG",{src:!0,alt:!0,class:!0}),xe=g(ge),M=s(ge,"DIV",{class:!0});var ve=d(M);te=s(ve,"SPAN",{class:!0});var Ke=d(te);qe=S(Ke,Le),Ke.forEach(r),Ee=g(ve),R=s(ve,"SPAN",{class:!0,"data-svelte-h":!0}),he(R)!=="svelte-9edoe1"&&(R.textContent=He),ve.forEach(r),ge.forEach(r),W.forEach(r),H.forEach(r),Ie=g(t),ae=s(t,"DIV",{class:!0});var Je=d(ae);F=s(Je,"IMG",{src:!0,alt:!0,class:!0}),Je.forEach(r),Ae=g(t),A=s(t,"DIV",{class:!0});var re=d(A);de=ct(re,!1),ue=g(re),N=s(re,"DIV",{class:!0});var Qe=d(N);for(let J=0;J<y.length;J+=1)y[J].l(Qe);Qe.forEach(r),Se=g(re),$=s(re,"DIV",{class:!0,"data-svelte-h":!0}),he($)!=="svelte-egnsom"&&($.innerHTML=je),re.forEach(r),Te=g(t),se=s(t,"DIV",{class:!0});var Ue=d(se);L=s(Ue,"DIV",{class:!0});var me=d(L);G=s(me,"H2",{class:!0,"data-svelte-h":!0}),he(G)!=="svelte-zd86x0"&&(G.textContent=Be),Ce=g(me),O=s(me,"DIV",{class:!0});var Xe=d(O);for(let J=0;J<w.length;J+=1)w[J].l(Xe);Xe.forEach(r),me.forEach(r),Ue.forEach(r),Ve=g(t),K=s(t,"DIV",{class:!0,"data-svelte-h":!0}),he(K)!=="svelte-gz11wi"&&(K.innerHTML=Re),t.forEach(r),this.h()},h(){a(p,"name","description"),a(p,"content",l[0].excerpt),a(b,"class","category-tag svelte-15qmzvl"),a(z,"class","dot svelte-15qmzvl"),a(_,"class","date-time svelte-15qmzvl"),a(f,"class","post-meta svelte-15qmzvl"),a(D,"class","svelte-15qmzvl"),a(ee,"class","post-excerpt svelte-15qmzvl"),De(B.src,Me=l[0].authorImage)||a(B,"src",Me),a(B,"alt",l[0].author),a(B,"class","author-image svelte-15qmzvl"),a(te,"class","author-name svelte-15qmzvl"),a(R,"class","author-title svelte-15qmzvl"),a(M,"class","author-details svelte-15qmzvl"),a(P,"class","author-info svelte-15qmzvl"),a(h,"class","container svelte-15qmzvl"),a(m,"class","post-header svelte-15qmzvl"),De(F.src,We=l[0].image)||a(F,"src",We),a(F,"alt",l[0].title),a(F,"class","svelte-15qmzvl"),a(ae,"class","post-image svelte-15qmzvl"),de.a=ue,a(N,"class","post-tags svelte-15qmzvl"),a($,"class","post-share svelte-15qmzvl"),a(A,"class","post-content container svelte-15qmzvl"),a(G,"class","svelte-15qmzvl"),a(O,"class","related-grid svelte-15qmzvl"),a(L,"class","container svelte-15qmzvl"),a(se,"class","related-posts svelte-15qmzvl"),a(K,"class","cta-section svelte-15qmzvl"),a(c,"class","blog-post svelte-15qmzvl")},m(n,x){e(document.head,p),we(n,u,x),we(n,c,x),e(c,m),e(m,h),e(h,f),e(f,b),e(b,j),e(f,q),e(f,_),e(_,C),e(C,E),e(_,X),e(_,z),e(_,V),e(_,k),e(k,I),e(h,Z),e(h,D),e(D,be),e(h,_e),e(h,ee),e(ee,ke),e(h,ze),e(h,P),e(P,B),e(P,xe),e(P,M),e(M,te),e(te,qe),e(M,Ee),e(M,R),e(c,Ie),e(c,ae),e(ae,F),e(c,Ae),e(c,A),de.m(st,A),e(A,ue),e(A,N);for(let t=0;t<y.length;t+=1)y[t]&&y[t].m(N,null);e(A,Se),e(A,$),e(c,Te),e(c,se),e(se,L),e(L,G),e(L,Ce),e(L,O);for(let t=0;t<w.length;t+=1)w[t]&&w[t].m(O,null);e(c,Ve),e(c,K)},p(n,[x]){if(x&1&&o!==(o=n[0].title+" | WASAW Blog")&&(document.title=o),x&1){ie=fe(n[0].tags);let t;for(t=0;t<ie.length;t+=1){const H=et(n,ie,t);y[t]?y[t].p(H,x):(y[t]=tt(H),y[t].c(),y[t].m(N,null))}for(;t<y.length;t+=1)y[t].d(1);y.length=ie.length}if(x&2){le=fe(n[1]);let t;for(t=0;t<le.length;t+=1){const H=Ze(n,le,t);w[t]?w[t].p(H,x):(w[t]=at(H),w[t].c(),w[t].m(O,null))}for(;t<w.length;t+=1)w[t].d(1);w.length=le.length}},i:ye,o:ye,d(n){n&&(r(u),r(c)),r(p),Ye(y,n),Ye(w,n)}}}function pt(l,o,p){let u;lt(l,dt,b=>p(2,u=b));const c=u.params.id,m=[{id:"1",title:"The Future of Real Estate: Emerging Trends for 2024",excerpt:"Explore the innovative trends reshaping the real estate landscape and how savvy investors can position themselves for success.",date:"April 25, 2024",author:"Waiel Grey",authorImage:"/images/wasaw_white.svg",tags:["Trends","Market Analysis","Investment"],category:"Market Insights",readTime:"5 min read",image:"/images/wasaw_white.svg",content:`
      ...
      `},{id:"2",title:"Luxury Property Staging: The Art of Creating Irresistible Spaces",excerpt:"Discover the psychological principles and design strategies behind staging high-end properties that command premium prices.",date:"April 18, 2024",author:"Albara Al-Shujaa",authorImage:"/images/wasaw_white.svg",tags:["Luxury","Design","Staging"],category:"Luxury Properties",readTime:"7 min read",image:"/images/wasaw_white.svg",content:`
      ...
      `}],h=m.find(b=>b.id===c)||m[0],f=m.filter(b=>b.id!==h.id).slice(0,3);return[h,f]}class yt extends nt{constructor(o){super(),rt(this,o,pt,ut,it,{})}}export{yt as component};
